    ...
    internal sealed class Configuration : DbMigrationsConfiguration<PrivateSchoolEleniEntity.Models.PrivateSchoolDBContext>
    {
        ...
        protected override void Seed(PrivateSchoolEleniEntity.Models.PrivateSchoolDBContext context)
        {
            ...
            context.Students.AddOrUpdate(x => x.LastName,
                ...
                new Student() { FirstName = "Panos", LastName = "Vasileiou", DateOfBirth = new DateTime(1999, 12, 17), Course = "Java", Fees = 3500, PhotoUrl = "https://images.unsplash.com/photo-1574701147838-eb4e86cce813?ixlib=rb-1.2.1&auto=format&fit=crop&w=900&q=60", Email = "panos@gmail.com", Telephone = "2223334445" },
